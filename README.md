...
real-time data processing, Kubernetes, and Go. Enjoy mentoring junior engineers, testing new technologies
through proof-of-concepts, and delivering quality software from planning to production.
	Looking for opportunities to grow into technical leadership positions.
`
	...
	skills := map[string][]string{
		...
		"AI Assists": {
			"Claude Code", "Opencode", "Codex", "Github Copilot",
		},
	}
